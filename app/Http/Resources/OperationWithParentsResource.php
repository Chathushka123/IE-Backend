...
class OperationWithParentsResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            'expected_top_level_efficiency' => $this->expected_top_level_efficiency,
            'expected_upper_mid_level_efficiency' => $this->expected_upper_mid_level_efficiency,
            'expected_lower_mid_level_efficiency' => $this->expected_lower_mid_level_efficiency,

...
class OperationGradingSkillUpdateValidator
{
  public static function getUpdateRules($keyIgnore, array $rec = [])
  {
    return array_merge(OperationGradingSkillCommonValidator::getCommonRules(), [
      'skill_id' => [
        ...
        'integer',
        'exists:skills,id',
        Rule::unique('operation_grading_skill')->where('operation_grading_id', $rec['operation_grading_id'] ?? null)->ignore($keyIgnore),
      ],
    ]);
  }
}
